	...
	public class TweenLite {
		...
		public function initTweenVals($hrp:Boolean = false, $reservedProps:String = ""):void {
			...
			if (this.target is Array) {
				...
				if ((typeof(_specialVars.tint) != "undefined" || this.vars.removeTint == true) && this.target.hasOwnProperty("transform")) { //If we're trying to change the color of a DisplayObject, then set up a quasai proxy using an instance of a TweenLite to control the color.
